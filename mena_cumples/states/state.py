...
class State(rx.State):
    ...
    @rx.event
    def set_conditions_checked(self, value: bool):
        """Marca/desmarca el checkbox del modal de condiciones."""
        self.conditions_checked = value

    @rx.event
    def accept_conditions(self):
        """Acepta las condiciones desde el modal de la selección de packs."""
        if self.conditions_checked:
            self.conditions_acepted = True
            self.conditions_checked = False

    @rx.event
    def toggle_menu(self):
        """Abre/cierra el menú de navegación móvil."""
    ...
    def handle_ask_availability_click(self):
        ...
        Home ya no bloquea: el gate legal es el modal de packs.
        """
